...
migrations. It is a plaintext starting template for service APIs: authentication and
field-level encryption are intentionally not included. Opaque cursor protection remains part
of generic pagination. Two example domains (`user`, `payment`) show the full pattern end to end.
