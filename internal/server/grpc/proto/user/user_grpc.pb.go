...
const (
	UserService_CreateUser_FullMethodName         = "/vibe.user.v1.UserService/CreateUser"
	UserService_GetUser_FullMethodName            = "/vibe.user.v1.UserService/GetUser"
	UserService_ListUsers_FullMethodName          = "/vibe.user.v1.UserService/ListUsers"
	UserService_UpdateUser_FullMethodName         = "/vibe.user.v1.UserService/UpdateUser"
	UserService_DeleteUser_FullMethodName         = "/vibe.user.v1.UserService/DeleteUser"
	UserService_UpdateUserPassword_FullMethodName = "/vibe.user.v1.UserService/UpdateUserPassword"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vibe.user.v1.UserService",
