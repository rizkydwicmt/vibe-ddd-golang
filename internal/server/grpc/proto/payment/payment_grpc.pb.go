...
const (
	PaymentService_CreatePayment_FullMethodName   = "/vibe.payment.v1.PaymentService/CreatePayment"
	PaymentService_GetPayment_FullMethodName      = "/vibe.payment.v1.PaymentService/GetPayment"
	PaymentService_ListPayments_FullMethodName    = "/vibe.payment.v1.PaymentService/ListPayments"
	PaymentService_UpdatePayment_FullMethodName   = "/vibe.payment.v1.PaymentService/UpdatePayment"
	PaymentService_DeletePayment_FullMethodName   = "/vibe.payment.v1.PaymentService/DeletePayment"
	PaymentService_GetUserPayments_FullMethodName = "/vibe.payment.v1.PaymentService/GetUserPayments"
)
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vibe.payment.v1.PaymentService",
