...
// renders the outward ResponseAPI and (when the route requires it) encrypts it.
...
// ResponseAPI is the standard plaintext API response. Every service returns this
// shape before any optional encryption. Clients branch on `Code`, display
