...
const (
	...
	CodeInvalidEncryptedRequest ResultCode = "INVALID_ENCRYPTED_REQUEST"
...
func (c ResultCode) DefaultHTTPStatus() int {
	...
	case CodeInvalidPayload, CodeInvalidEncryptedRequest, CodeUnsupportedAPIVersion, CodeBadRequest:
