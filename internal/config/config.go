...
type CryptoConfig struct {
	DIPSPassword  string `mapstructure:"dips_password" validate:"omitempty,len=32"`
	DIPSAESMethod string `mapstructure:"dips_aes_method" validate:"omitempty,oneof=aes-256-cbc" default:"aes-256-cbc" normalize:"trim,lower"`
	DIPSIVLength  int    `mapstructure:"dips_iv_length" validate:"gte=0" default:"16"`
	EncryptKey    string `mapstructure:"encrypt_key" validate:"omitempty,len=32"`
	IVKey         string `mapstructure:"iv_key" validate:"omitempty,len=16"`
	Cipher        string `mapstructure:"cipher" validate:"omitempty,oneof=aes-256-cbc" default:"aes-256-cbc" normalize:"trim,lower"`
}
